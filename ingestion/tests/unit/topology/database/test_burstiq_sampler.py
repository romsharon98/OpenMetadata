...
class TestBurstIQSamplerRawDataset:
    ...
    def test_no_sample_caps_total_limit(self, sampler):
        # Unsampled profiles must not pull an unbounded chain into memory:
        # the limit falls back to the cap instead of None.
        sampler.sample_config = SampleConfig()
